...
switch ($_REQUEST["f"]){
	case "db_connect":
		$html .= "A problem has occurred connecting the the database - this usually means the database connection settings are wrong in the lib/config.php file";
		break;
	
	default:
		$html .= "An unspecified problem has occurred in the PluggedOut Blog script.";
		break;
}
